...
int main(void)
{
    ...
    LineObject line(Point(0.0f, 0.0f), Point(50.0f, 50.0f), 1.0f, 0.0f, 0.0f, true, 1.0f);
    //CircleObject circle(Point(120.0f, 120.5f), Point(10.0f, 20.0f), 1.0f, 0.0f, 0.0f, 0.0f, false, 10.0f);
    RectangleObject rectangle(Point(200.0f, 30.0f), Point(10.5f, 300.5f), 0.0f, 0.0f, 1.0f, false, 5.0f);
